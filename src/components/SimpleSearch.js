      ...
      <>
          ...
          >
						{
							categoryOptions.map((categoryOption, categoryOptionIndex) => (
								<option value={categoryOption.key} key={categoryOptionIndex}>{categoryOption.label}</option>		
							))
						}
          </select>
        </div>
          ...
          >
						{
							ingredientsOptions.map((ingredientOption, ingredientOptionIndex) => (
								<option value={ingredientOption.key} key={ingredientOptionIndex}>{ingredientOption.label}</option>		
							))
						}
          </select>
        </div>
        ...
        <nav className="search-by-keyword">
          <form action="#" onSubmit={e => e.preventDefault()}>
            <button onClick={onSearchTrigger}>
